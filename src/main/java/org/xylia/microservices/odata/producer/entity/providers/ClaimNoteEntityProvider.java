 ...
 * @author Rajesh Iyer 
 * 
 * ClaimNote Entity provider implementation class. 
 */

@Component
public class ClaimNoteEntityProvider extends BaseEntityProviderProcessorImpl implements EntityProvider {
	...
	// Entity Name
	public static final String ENTITY_NAME = "ClaimNote";
